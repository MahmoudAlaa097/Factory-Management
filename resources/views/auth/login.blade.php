...
<html lang="en">
    <head>
        ...
        <title>Sign In | Factory Management</title>
        <link rel="icon" href="favicon.ico"><link href="{{ asset('tailadmin/build/style.css') }}" rel="stylesheet">
    </head>
    <body
                                ...
                                <div>
                                    <form method="POST" action="/login">
                                        <div class="space-y-5">
                                            ...
                                            <div>
                                                <button
                                                class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600" type="submit"
                                                >
                                                Sign In
                                                </button>
                                            </div>
                        ...
                        <div class="flex items-center justify-center z-1">
                            ...
                            <div class="flex flex-col items-center max-w-xs">
                                <a href="index.html" class="block mb-4">
                                    <img src="{{ asset('tailadmin/build/src/images/logo/auth-logo.svg') }}" alt="Logo" />
                                </a>
